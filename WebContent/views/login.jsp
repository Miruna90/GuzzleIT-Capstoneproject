...
<head>
  ...
  <body>
    <header class="header">
         <a class="logo" href="/CapstoneProject/views/home.jsp"> <img src="/CapstoneProject/Images/new1.png" alt="logo" style="max-width: 100%"></a>
            <nav>
                <ul class="nav_links">
  ...
  width: 100%;
  height: 500px;
  background-image: url('/CapstoneProject/Images/login.jpg');
  background-size: 100% 100%;">
          <div class="row">
            <div class="col-md-4 col-sm-4 col-xs-12"></div>
            <div class="col-md-4 col-sm-4 col-xs-12">
              <form class="form-container" action="/CapstoneProject/UserServlet?request_type=login" method="post">
                <h1 id="signin" style="text-align: center; color: #232020"> Login</h1>
                 <p style="color: red; text-align: center;right:20px;">${errorMessage}</p>
                  ...
                  <button type="submit" value="LOGIN" class="btn btn-success btn-block" style="align-items: center">Login</button>
                </form>
